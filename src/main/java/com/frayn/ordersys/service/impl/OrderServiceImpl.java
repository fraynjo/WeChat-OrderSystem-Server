...
import com.frayn.ordersys.converter.OrderMaster2OrderDTOConverter;
import com.frayn.ordersys.dataobject.OrderDetail;
import com.frayn.ordersys.dataobject.OrderMaster;
...
import com.frayn.ordersys.repository.OrderDetailRepository;
import com.frayn.ordersys.repository.OrderMasterRepository;
import com.frayn.ordersys.service.OrderService;
import com.frayn.ordersys.service.ProductService;
import com.frayn.ordersys.utils.KeyUtil;
...
//        List<CartDTO> cartDTOList = new ArrayList<> ;
        ...
        for (OrderDetail orderDetail : orderDTO.getOrderDetailList()) {
            ...
            //订单详情入库
            BeanUtils.copyProperties(productInfo, orderDetail); // Spring 提供的方法，将 productInfo 属性拷贝到 orderDetail
